        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            success:
                function (file, response) {
                    $('form').append('<input type="hidden" class="imagefile" name="document[]" value="' + response.name + '">')
            ...
            init: function () {
                ...
                {!! json_encode($event->document) !!}
                    ...
                    $('form').append('<input class="imagefile" type="hidden" name="document[]"  value="' + file.file_name + '">')
                }
                @endif
            }
        }
...
console.log('asasd');
            ...
            if(confirm('Are you sure you want to delete this attachment?')) {
                $.ajax({
                    ...
                    type: "POST",
                    data: {'filename':image, 'lead_slug': $('#lead_slug').val()},
                    success: function(data) {
                        setTimeout(function() {
                            toastr["success"]('Attachment has been deleted.', 'Success');
                            $('.filesul').load(document.URL + ' .filesul');
                        },500);
                    }
                });
            }
